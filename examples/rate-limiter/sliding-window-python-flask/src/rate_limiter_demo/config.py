...
class AppConfig(BaseSettings):
    ...
    flask_host: str = Field(default="127.0.0.1", min_length=1, validation_alias="FLASK_HOST")
    flask_port: int = Field(default=8000, ge=1, le=65_535, validation_alias="FLASK_PORT")
